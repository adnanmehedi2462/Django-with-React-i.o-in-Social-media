  ...
  const [output,setOutput]=useState([])
    ...
    const getpostdata = async () => {
        ...
        await Axios({method: "get",
         url: "http://localhost:8000/myallpost"
        }).then(
            response => {
...
<div className="blog-list-area-wrapper index-01">
     ...
     { output.length === 0 && input.length > 0 &&  (<> <center> <img src='https://cdni.iconscout.com/illustration/premium/thumb/search-result-not-found-2130355-1800920.png' /> <h1 style={{'color':'red'}}>"Content Not Found. 😢 !!"</h1></center> </>)}
    ...
    <div className="single-blog-list-1-index-1 wow bounceInUp" data-wow-duration="1.8s">
         <div className="content-top">
             ...
             <div className="img-box">
                 ...
                 <img src={`http://localhost:8000${P.image} `}    onError={(event) => event.target.style.display = 'none'}  />  
             </div>
         ...
         <div className="content-top">
             ...
             <div className="content-bottom">
                 ...
                 <div className="post-meta">
                     <div className="left-content">
                         <div className="btn-wrapper">
                             <Link to={'/login'} className="reading-btn">continue reading</Link>
                         </div>
                     </div>
                     <div className="right-content">
                         <ul className="list">
                             <li className="list-item">
                                 <Link  to={`writer${P.id}`}>
                                     <i className="far fa-user icon"></i>
                                     <Link to={'/login'} className="text">{P.author.user.username}</Link>
                                 </Link>
                             </li>
